...
internal constructor(val context: Context, data: ArrayList<String>, photos: ArrayList<Bitmap>, val ids: ArrayList<Int>/*url: ArrayList<URL>*/) : RecyclerView.Adapter<MyRecyclerViewAdapter.ViewHolder>() {
    ...
    inner class ViewHolder internal constructor(itemView: View) : RecyclerView.ViewHolder(itemView),
        ...
        override fun onClick(view: View) {
            ...
            val intent = Intent(Intent.ACTION_VIEW, Uri.parse("https://vk.com/id${ids[holderId!!]}"))
